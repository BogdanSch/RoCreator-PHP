...
try {
    ...
    if (!$conn->query("CREATE TABLE IF NOT EXISTS Games_Table (id INT NOT NULL AUTO_INCREMENT, article_author VARCHAR (100), article_date DATETIME, article_title VARCHAR(100), article_content TEXT, article_type VARCHAR(100), PRIMARY KEY (id))")) {
    ...
    if (!$conn->query("INSERT INTO Games_Table (article_author, article_date, article_title, article_content, article_type) VALUES ('admin', NOW(), 'How to become a programmer', 'Some content here', 'programmer')")) {
        throw new Exception('Error creation table  Users: [' . $conn->error . ']');
    }
